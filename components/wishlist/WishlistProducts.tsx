...
export default function WishlistProducts() {
  ...
  const handleResetWishlist = () => {
    ...
    if (confirmReset) {
      resetFavorite();
      toast("Wishlist reset successfully");
    }
  }
  ...
  return (
    <Container className="my-4">
      {favoriteProduct?.length > 0 ? (
        <>
          <div className="overflow-x-auto table-auto md:table-fixed">
            <table className="w-full border-collapse">
              ...
              <tbody>
                {favoriteProduct
                  ...
                  ?.map((product: Product) => {
                    return (
                      <tr key={product?._id} className="border-b space-y-10 md:space-y-0">
                        ...
                        <td className="p-2 capitalize hidden text-sm md:table-cell">
                          {product?.variant}
                        </td>
                        <td
          ...
          <div className="flex items-center justify-center gap-2">
            {visibleProducts < favoriteProduct?.length && (
              <div className="my-5">
                <Button className="border-shop_dark_green text-shop_dark_green font-semibold" variant="outline" onClick={loadMore}>
                  Load More
                </Button>
              </div>
            )}
            {visibleProducts > 10 && (
              <div className="my-5">
                <Button
                  className="border-shop_dark_green text-shop_dark_green font-semibold"
