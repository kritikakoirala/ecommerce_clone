...
const SuccessPageContent = () => {
  ...
  return (
    <div className="py-10 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center mx-4">
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <Link
            href="/orders"
            className="flex items-center justify-center  font-semibold bg-lightGreen text-black border border-lightGreen rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-md"
          >
          ...
          <Link
            href="/"
            className="flex items-center justify-center font-semibold bg-black text-white rounded-lg hover:bg-gray-800 transition-all duration-300 shadow-md"
          >
